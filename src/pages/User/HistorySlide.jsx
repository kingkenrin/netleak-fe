...
export default function HistorySlide({ movies, handleDeleteHistotyFilm }) {
  //   const movies= data;
              ...
              <div className="flex flex-row content-between ">
                ...
                <div className="w-1/5 flex items-center justify-end">
                  <div onClick={() => {
                    setShownModal(true)
                    setFilmId(movie._id)
                  }} className="w-[30px] h-[30px] cursor-pointer flex items-center justify-center rounded-md hover:bg-red-600 duration-150 east-out group">
      ...
      {shownModal && (
        <div className="z-50 fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-5 rounded shadow-lg">
            <p className=" text-black">Bạn có chắc chắn muốn xóa không?</p>
            ...
            <div className="flex justify-end mt-4 p-5 rounded-md">
              ...
              <button
                onClick={() => {
                  handleDeleteHistotyFilm(filmId)
                  setFilmId("")
                  setShownModal(false)
                }}
